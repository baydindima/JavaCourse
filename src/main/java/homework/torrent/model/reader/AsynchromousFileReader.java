 ...
 */
@Slf4j
public class AsynchromousFileReader {
    ...
    public AsynchromousFileReader(@NotNull final AsynchronousSocketChannel outputChannel,
                                  @NotNull final Path filePath,
                                  final long offset,
                                  final int length) {
        this.socketChannel = outputChannel;
